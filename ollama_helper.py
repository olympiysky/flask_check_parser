...
def get_category_ollama(product_name: str) -> str:
    prompt = (
        ...
        "Определи категорию из списка: Сладости, Снеки, Хозтовары, Напитки, Продукты, Овощи, Фрукты, Мясо, Компьютеры, Игры.\n"
    ...
    try:
        ...
        if "response" in data:
            ...
            valid_categories = {"Сладости", "Снеки", "Хозтовары", "Напитки", "Продукты", "Овощи", "Фрукты", "Мясо", "Компьютеры", "Игры"}
